...
<body>
    ...
    <script src="{{ asset('survey-assets/js/jquery-3.6.0.min.js') }}"></script>
    <script src="{{ asset('survey-assets/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('survey-assets/js/browser@4.js') }}"></script>
